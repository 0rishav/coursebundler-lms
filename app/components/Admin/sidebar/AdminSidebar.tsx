      ...
      >
        <Menu iconShape="square">
          <MenuItem
            ...
            icon={isCollapsed ? <ArrowForwardIosIcon className="dark:bg-white bg-black" /> : undefined}
            style={{
          ...
          <Box paddingLeft={isCollapsed ? undefined : "10%"}>
            ...
            <Typography
              variant="h5"
              className="!text-[18px] text-black dark:text-[#ffffffc1] capitalize !font-[400]" sx={{m:"15px 0 5px 20px"}}
            >
                {!isCollapsed && "Content"}
            </Typography>
            <Item
