...
const AllUsers: FC<Props> = ({ isTeam }) => {
  ...
  useEffect(() => {
    if (updateError) {
      if ("data" in updateError) {
        const errorMesage = updateError as any;
  ...
  }, [isSuccess, updateError,deleteError,deleteSuccess]);
  ...
  const columns = [
    ...
    { field: "created_at", headerName: "joined_at", flex: 0.5 },
      ...
      <Box m={"20px"}>
        {isTeam && (
          <div className="w-full flex justify-end">
            <div
              className={`${styles.button} !w-[250px] dark:bg-[#57c7a3] dark:text-white text-black !h-[35px] dark:border dark:border-[#ffffff6c]`}
        ...
        >
          <Box className="absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 w-[450px] bg-white dark:bg-slate-900 rounded-[8px] shadow p-4 ouline-none">
            ...
            <div className="mt-4">
              ...
              <br />
              <div
                className={`${styles.button} my-6 !h-[30p]`}
