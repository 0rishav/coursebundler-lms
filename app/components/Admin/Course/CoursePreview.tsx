    ...
    <div className="w-[90%] 800px:w-[90%] m-auto py-5 mb-5">
      <div className="w-full relative">
        ...
        <div className="flex items-center">
          ...
          <h5 className="pl-3 text-[20px] dark:text-white text-black mt-2 line-through opacity-80">
            {courseData?.estimatedPrice}$
          </h5>
        ...
        <p className="pb-1 dark:text-white text-black">Full Life Time Access</p>
      ...
      <div className="w-full">
        <div className="w-full 800px:pr-5">
          ...
          <br />
          <h1 className="text-[25px] font-Poppins font-[400] dark:text-white text-black">
        ...
        <br />
        <h1 className="text-[25px] font-Poppins font-[600] dark:text-white text-black">
          What are the prerequisite for starting thsi course?
        </h1>
